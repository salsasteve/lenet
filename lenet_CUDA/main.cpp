...
//                                                    dense_quantized_parameters_1.biases_zero_points);
	...
	cout << dense1Activated[0] << " " << dense1Activated[1] << " " <<"\n";
	...
	cout << dense2Activated[0] << " " << dense2Activated[1] << " " <<"\n";
        // print dimensions of the dense layer
	...
	cout << dense3Layer[0] << " " << dense3Layer[1] << " " <<"\n";
        // Apply the activation function
        vector<float> dense3Activated = softmax1D(dense3Layer);
	cout << dense3Activated[6] << dense3Activated[7] << dense3Activated[8] <<"\n";
        // print dimensions of the dense layer
