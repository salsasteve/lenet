...
static layer_t LAYER_1 = {.class=Avgpooling, .activation=&fp_linear, .numChannels=6, .padding=Valid, .stride_numCols=2, .stride_numRows=2, .pool_numCols=2, .pool_numRows=2};
...
static layer_t LAYER_3 = {.class=Avgpooling, .activation=&fp_linear, .numChannels=16, .padding=Valid, .stride_numCols=2, .stride_numRows=2, .pool_numCols=2, .pool_numRows=2};
...
static layer_t LAYER_7 = {.class=Dense, .activation=&fp_linear, .kernel=&DENSE_3_WEIGHTS_MAT, .bias=&DENSE_3_BIASES_MAT};
